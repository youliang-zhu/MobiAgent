...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str,
                       default=os.path.expanduser("~/mobiAgent/MobiAgent/workspace/data/training_data/unexpected_data"),
                       help="输出目录 (default: ~/mobiAgent/MobiAgent/workspace/data/training_data/unexpected_data)")
