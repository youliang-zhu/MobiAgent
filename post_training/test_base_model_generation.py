...
def test_model_generation(api_url="http://localhost:8000/v1/chat/completions"):
    """
    ...
    data_path = Path("/home/agent/mobiAgent/MobiAgent/tools_for_reproduction/generated_data/grpo_data/mobimind_decider_grpo_train.json")
...
if __name__ == "__main__":
    ...
    test_model_generation(api_url=args.api_url)
